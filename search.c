...
short evaluate()
{
        ...
        score += (popuCount(w_silver) - popuCount(b_silver)) * 350;
        score += (popuCount(w_gold) - popuCount(b_gold)) * 400;
        ...
        score += (W_HAND(silver) - B_HAND(silver)) * 400;
        score += (W_HAND(gold) - B_HAND(gold)) * 500;
